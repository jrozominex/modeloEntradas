...
<body>
    <?php include('./header.php'); echo $sql; ?>
                ...
                <form method="post">
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            ?>
                            <select id="empresa"  name="empresa" class="form-control" onchange="validar()">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select id="cliente" style="border-color: #3CB6EB;" name="cliente" class=" form-control" onchange="validar()"> 
                                <option value="0">Seleccione</option>
                                <?php 
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="date" onclick="validar()" name="fecha_inicio" id="fecha_inicio" class="form-control" value="<?php if(isset($_POST['fecha_inicio'])){ if(!empty($_POST['fecha_inicio'])){ echo $_POST['fecha_inicio'];  }}else{ echo $Fecha; } ?>">
                        </div>
                        <div class="col-sm-2">
                            <label>Fecha Fin:</label>
                            <input type="date" onclick="validar()" name="fecha_fin" id="fecha_fin" class="form-control" value="<?php if(isset($_POST['fecha_fin'])){ if(!empty($_POST['fecha_fin'])){ echo $_POST['fecha_fin'];  }}else{ echo $Fecha; } ?>">
                        </div>
                        <div class="col-sm-2">
                            <label>Factura:</label>
                            <input type="hidden" name="selected" id="selected" value="<?php if(isset($_POST['facturas'])){ if($_POST['facturas'] != '0'){  echo $_POST['facturas'];  }else{ echo 0;} } ?>">
                            <select class="form-control" name="facturas" id="facturas">
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table table-hover table-condensed table-bordered table-responsive table-striped">
                    ...
                    {   // VARIABLES CONTADORES
                        ...
                        ?>
                        <tr>
                            <td style="vertical-align: middle; text-align: center;"><a href="../vista/informe_horometros-pdf.php?idTiquete=<?php echo $r['id_registro']; ?>" target="_blank"><?php echo $r['cod_reporte']; ?></a></td>
                            ...
                            while($horometro = sqlsrv_fetch_array($res_1)){
                                ...
                                ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                    ...
                                    ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                        ...
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                            ?><td style="vertical-align: middle; text-align: center;"><?php if($cont_room == 1){ echo number_format($total_room_alimentar,1); }else{ echo 0; } ?></td><?php
                                            $total_room_apilar+=$horometro['total_horas'];
                                            $total_horas+=$horometro['total_horas'];
                                            $cont_room = 2;
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                    ...
                                    ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                        ...
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                            ?><td style="vertical-align: middle; text-align: center;"><?php if($cont_sobreta == 1){ echo number_format($total_sobretamaño_alimentar,1); }else{ echo 0; } ?></td><?php
                                            $total_sobretamaño_apilar+=$horometro['total_horas'];
                                            $total_horas+=$horometro['total_horas'];
                                            $cont_sobreta = 2;
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                    ...
                                    ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                        ...
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                            ?><td style="vertical-align: middle; text-align: center;"><?php if($cont_entradas == 1){ echo number_format($total_entradas_apilar,1); }else{ echo 0; } ?></td><?php
                                            $total_entradas_mvto+=$horometro['total_horas'];
                                            $total_horas+=$horometro['total_horas'];
                                            $cont_entradas = 2;
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                    ...
                                    ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                        ...
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                            ?> <td style="vertical-align: middle; text-align: center;"><?php if($cont_molienda == 1){ echo number_format($total_molienda_alimentar,1); }else{ echo 0; } ?></td> <?php
                                            $total_molienda_apilar+=$horometro['total_horas'];
                                            $total_horas+=$horometro['total_horas'];
                                            $cont_molienda = 2;
                                        ///////////////////////////////////////////////////////////////////////////////////////////////////////
