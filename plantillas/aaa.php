            ...
            <div class="col-sm-12 table-responsive">
                ...
                <table class="table table-hover table-condensed table-bordered table-responsive table-striped">
                    ...
                    {   $paso = 0;
                        ...
                        ?>
                        <tr>
                            <td style="vertical-align: middle; text-align: center;"><?php echo $r['cod_reporte']; ?></td>
                            ...
                            <td style="vertical-align: middle; text-align: center;"><?php echo $r['horas_trabajadas']; ?></td>
                            <?php 
                                ...
                                if($band == 0){
                                    if($horometro['Descripcion'] == 'CLASIFICAR ROOM'){
                                        ...
                                        if($horometro['Descripcion_sub'] == 'ALIMENTAR'){
                                            ...
                                            <?php
                                            if($name_act == "a"){
                                                $name_act = $horometro['Descripcion_sub'];
                                                $valor_horo+=$horometro['total_horas'];
                                            }elseif($name_act == $horometro['Descripcion_sub']){
                                                $valor_horo+=$horometro['total_horas'];
                                            }else{
                                                ?>
                                                <td style="vertical-align: middle; text-align: center;"><?php echo number_format($valor_horo,1,'.',','); ?></td>
                                                <?php
                                                $name_act = $horometro['Descripcion_sub'];
                                                $valor_horo = 0;
                                                $valor_horo+=$horometro['total_horas'];
